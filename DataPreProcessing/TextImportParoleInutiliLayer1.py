...
#Questo file è una modifica di TextImportParoleInutili, unica differenza è che prendiamo le parole del layer 1 e non layer 3! 
...
with open('corpusParoleInutiliStemming_layer1.pkl', 'wb') as file:
