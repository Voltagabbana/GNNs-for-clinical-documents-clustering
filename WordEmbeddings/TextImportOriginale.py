...
## Per runnare uno script .py su colab: 
#!python filename.py # su colab # non funziona perchè non trova i dati...
...
with open('corpus_filtrato15_11.pkl', 'wb') as file_pickle:
    # Salva la lista di liste nel file
    pickle.dump(corpus_filtrato, file_pickle)
