## modifica del file arguments per il caso di clustering
import argparse

def arg_parse():
    parser = argparse.ArgumentParser(description='GcnInformax Arguments.')
    #parser.add_argument('--DS', dest='DS', help='Dataset')
    #\ https://chrsmrrs.github.io/datasets/docs/datasets/ questo è il sito da cui vengono downloaddati i datasets!
