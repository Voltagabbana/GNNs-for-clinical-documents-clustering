...
class Encoder(torch.nn.Module):
    ...
    def forward(self, x, edge_index, batch):
        ...
        #xpool = [global_add_pool(x, batch) for x in xs] #modificato 4 Marzo per vedere se con la media al posto
            # della somma i risultati sono più indipendenti dalla lunghezza dei grafi
